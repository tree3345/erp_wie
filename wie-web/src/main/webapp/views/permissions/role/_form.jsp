...
<div style="padding:20px">
	<table cellpadding="0" cellspacing="0" class="form-table">
		...
		<tr>
			<td>角色状态：</td>
			<td><input id="status" class="easyui-combobox" name="role.status" style="width:200px" required="true" editable="false"
		...
		<tr>
			<td>登陆角色：</td>
			<td><input id="loginRole" class="easyui-combobox" name="role.loginRole" style="width:200px" required="true" editable="false"
