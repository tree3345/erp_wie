				...
				<table cellpadding="0" cellspacing="0" style="width: 95%;" fit="true">
					<tr>
						<td style="text-align: left">
						   <tgEasyui:easyuiButton iconCls="icon-add" method="newItem()" permission="module:add" operationName="新增" />
							<tgEasyui:easyuiButton iconCls="icon-edit" method="editItem()" permission="module:modify" operationName="修改" />
							<tgEasyui:easyuiButton iconCls="icon-cancel" method="delItem()" permission="module:delete" operationName="删除" />
						    &nbsp;
							模块名：
							<input id="moduleName_q" class="easyui-textbox"/>
							&nbsp;
							视图：
							<input id=viewName_q" class="easyui-textbox"/>
							&nbsp;
