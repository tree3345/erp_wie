...
<body style="margin: 0; padding: 0; height: 100%; overflow: hidden; background: #F2FBFF">
	<div class="easyui-layout" fit="true">
		...
		<div id="searcher" style="width:100%;height:11%" border="false">
		  <table>
                        <tr>
                            <th><span class="inp1">错误内容：<span></span></th>
                            <td><input  class="easyui-textbox" id="errorContent"  name="bill.errorContent"/></td>
                            <th><span class="inp1">mac地址：</span></th>
                            <td><input class="easyui-textbox"  id="macAddress" name="bill.macAddress"/></td>
                        </tr>
                        <tr>
