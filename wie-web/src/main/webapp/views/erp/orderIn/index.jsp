...
<head>
	...
	<script src="<c:url value="/js/easyui/locale/easyui-lang-zh_CN.js"/>"></script>
	 <script type="text/javascript">
        	...
        	var isaudit='order';
        	var checkUrl =contextPath+'/orderIn/checkOrderIn.tg';
	...
	<script type="text/javascript">
		$(function(){
			$('#dg-bills').billgrid({
				createUrl:'<c:url value="/orderIn/createOrderIn.tg"/>',
				editUrl:'<c:url value="/orderIn/editOrderIn.tg"/>',
				destroyUrl:'<c:url value="/orderIn/destroyOrderIn.tg"/>',
				query:{
					title:'查询采购入库单',
					form:'<c:url value="/views/erp/orderIn/_query.jsp"/>',
					width:450,
					height:230,
...
<body>
	<div class="easyui-layout" fit="true">
				...
				<table cellpadding="0" cellspacing="0" style="width:100%">
					<tr>
						...
						<td style="text-align:right">
							...
							<input id="q" class="easyui-searchbox" prompt="单据编号" searcher="normalQuery" style="width:200px"/>
		...
		<div region="center" border="false">
			<table id="dg-bills" 
					url="<c:url value='/orderIn/getItemsOrderIn.tg'/>?orderIn.flag=${flag}"
					idField="id" fit="true" fitColumns="true" singleSelect="true"
					pagination="true" border="false" rownumbers="true">
				<thead>
					<tr>
						<th field="orderNumber" width="80">单据编号</th>
						...
						<th field="createBy" width="100" formatter="formatType">制单人</th>
						<th field="remark" width="100"">备注</th>
						<th field="totalCount" width="60" align="right" formatter="formatDecimal">数量</th>
						<th field="totalPrice" width="80" align="right" formatter="formatDecimal">金额</th>
	...
	<div id="dlg-bill" class="easyui-dialog" title="订单计划" style="width:850px;height:450px;position:relative"
			closed="true">
	</div>
</body>
