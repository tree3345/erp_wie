...
/** 
  ...
  */
@Repository
public class PaymentDetailDao extends BaseDAO<PaymentDetail> {
	...
	/** 
	  ...
	  * @throws 
	  */
	public Pagination getPageList(PaymentDetail paymentDetail,int page, int rows,String sort,String order) {
		StringBuffer sb = new StringBuffer("from PaymentDetail bd where 1=1");
	...
	public List<PaymentDetail> getAll(){
		StringBuffer sb = new StringBuffer("from PaymentDetail where 1=1");
