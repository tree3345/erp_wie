...
import com.wie.permissions.biz.IGroupService;
...
public class UserTg extends BaseTg{
    ...
    public void savestoresTo(){
		String storeIds=request.getParameter("storeIds");
		if(storeIds != null){
			this.userService.addStoresToUser(storeIds, id);
		}

		returnJsion("{\"success\":\"true\"}",response);
	}
	public void deletestoresFrom(){
		String storeIds=request.getParameter("storeIds");
		this.userService.delStoresFromUser(id, storeIds);
		returnJsion("{\"success\":\"true\"}",response);
	...
	{
		user=new Users();
		String logonid=request.getParameter("q");
	...
	public void getOther(){
		...
		List<Users> grouPAll = this.userService.getGroupAll(id);
	...
	public void getItems(){
		...
		if(null != id && !"".equals(id)){
			list = this.userService.getGroupAll(id);
		}else{
