...
import com.wie.common.poi.excel.entity.ComparatorExcelField;
import com.wie.common.poi.excel.entity.ExcelExportEntity;
import com.wie.common.poi.excel.entity.ExcelTitle;
import com.wie.common.poi.excel.entity.TemplateExportParams;
...
public final class ExcelExportUtil {
	...
	private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row,
		...
		if(entity.getExportImageType()==1){
			...
			try {
				String path = ServletActionContext.getRequest().getSession().getServletContext().getRealPath("\\") +string;
